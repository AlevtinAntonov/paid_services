...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget_Contracts.setColumnCount(10)
        self.tableWidget_Contracts.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_Contracts.setHorizontalHeaderItem(9, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tableWidget_Contracts.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "ID"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Number"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Date"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Child"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Lesson"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Team"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Remaks"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "Signed"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "Cancel_Date"))
        item = self.tableWidget_Contracts.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "CA_Signed"))
